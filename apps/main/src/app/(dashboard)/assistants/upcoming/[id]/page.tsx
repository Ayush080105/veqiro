  ...
  return (
    <div className="flex h-full flex-1 flex-col bg-background">
      ...
      <div className="flex items-center gap-3 border-b border-(--vq-line-2) bg-card px-5 py-4">
        <div
          className="grid size-9 shrink-0 place-items-center rounded-full font-head text-xs text-white"
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-5 p-10 text-center">
        <div className="flex size-18 shrink-0 items-center justify-center rounded-[var(--vq-r)] bg-muted">
      ...
      <div className="border-t border-(--vq-line-2) bg-card px-4 py-3">
        <div className="flex cursor-not-allowed items-center gap-2.5 rounded-[var(--vq-r)] border border-border bg-background px-4 py-3 opacity-50">
