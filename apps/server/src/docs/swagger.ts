...
import { sendMessageSchema as vegaSendMessageSchema } from "../modules/agents/vega/vega.schema.js";
...
const vegaChatPost: ZodOpenApiOperationObject = {
  ...
  summary: "Vega chat",
  description: "Conversational executive-assistant chat.",
  tags: ["Vega"],
  requestBody: {
    required: true,
    content: {
...
export const openApiDocument = createDocument({
  ...
  tags: [
    ...
    { name: "Vega", description: "Executive assistant agent" },
    {
      name: "Integrations",
      description:
