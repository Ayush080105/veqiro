-- Drop old expense tables (safe — no real data yet)
DROP TABLE IF EXISTS "settlement" CASCADE;
DROP TABLE IF EXISTS "expense_split" CASCADE;
DROP TABLE IF EXISTS "expense" CASCADE;
DROP TABLE IF EXISTS "expense_group_member" CASCADE;
DROP TABLE IF EXISTS "expense_group" CASCADE;
DROP TYPE IF EXISTS "ExpenseCategory";
DROP TYPE IF EXISTS "SplitType";
