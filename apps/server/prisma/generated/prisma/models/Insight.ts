...
export type InsightGroupByOutputType = {
  ...
  suggestedActionId: string | null
  suggestedArgs: runtime.JsonValue | null
  objectKind: string | null
  objectId: string | null
  runId: string | null
  expiresAt: Date | null
...
export type InsightWhereInput = {
  ...
  agent?: Prisma.EnumAgentFilter<"Insight"> | $Enums.Agent
  dedupeKey?: Prisma.StringFilter<"Insight"> | string
  ...
  suggestedActionId?: Prisma.StringNullableFilter<"Insight"> | string | null
  suggestedArgs?: Prisma.JsonNullableFilter<"Insight">
  objectKind?: Prisma.StringNullableFilter<"Insight"> | string | null
  objectId?: Prisma.StringNullableFilter<"Insight"> | string | null
  runId?: Prisma.StringNullableFilter<"Insight"> | string | null
  expiresAt?: Prisma.DateTimeNullableFilter<"Insight"> | Date | string | null
  acknowledgedAt?: Prisma.DateTimeNullableFilter<"Insight"> | Date | string | null
  acknowledgedByUserId?: Prisma.StringNullableFilter<"Insight"> | string | null
  metadata?: Prisma.JsonNullableFilter<"Insight">
...
export type InsightOrderByWithRelationInput = {
  ...
  suggestedActionId?: Prisma.SortOrderInput | Prisma.SortOrder
  suggestedArgs?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type InsightWhereUniqueInput = Prisma.AtLeast<{
  id?: string
  organizationId_dedupeKey?: Prisma.InsightOrganizationIdDedupeKeyCompoundUniqueInput
  AND?: Prisma.InsightWhereInput | Prisma.InsightWhereInput[]
  OR?: Prisma.InsightWhereInput[]
  NOT?: Prisma.InsightWhereInput | Prisma.InsightWhereInput[]
  organizationId?: Prisma.StringFilter<"Insight"> | string
...
export type InsightScalarWhereWithAggregatesInput = {
  ...
  agent?: Prisma.EnumAgentWithAggregatesFilter<"Insight"> | $Enums.Agent
  dedupeKey?: Prisma.StringWithAggregatesFilter<"Insight"> | string
  ...
  suggestedActionId?: Prisma.StringNullableWithAggregatesFilter<"Insight"> | string | null
  suggestedArgs?: Prisma.JsonNullableWithAggregatesFilter<"Insight">
  objectKind?: Prisma.StringNullableWithAggregatesFilter<"Insight"> | string | null
  objectId?: Prisma.StringNullableWithAggregatesFilter<"Insight"> | string | null
  runId?: Prisma.StringNullableWithAggregatesFilter<"Insight"> | string | null
  expiresAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Insight"> | Date | string | null
  acknowledgedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Insight"> | Date | string | null
  acknowledgedByUserId?: Prisma.StringNullableWithAggregatesFilter<"Insight"> | string | null
  metadata?: Prisma.JsonNullableWithAggregatesFilter<"Insight">
...
export type InsightCreateInput = {
  ...
  status?: $Enums.InsightStatus
  suggestedActionId?: string | null
  suggestedArgs?: Prisma.NullableJsonNullValueInput | runtime.InputJsonValue
  objectKind?: string | null
  objectId?: string | null
  runId?: string | null
...
export type InsightUpdateInput = {
  ...
  suggestedActionId?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  suggestedArgs?: Prisma.NullableJsonNullValueInput | runtime.InputJsonValue
...
export type InsightOrganizationIdDedupeKeyCompoundUniqueInput = {
  organizationId: string
  dedupeKey: string
}
...
export type InsightCountOrderByAggregateInput = {
  ...
  severity?: Prisma.SortOrder
  status?: Prisma.SortOrder
  suggestedActionId?: Prisma.SortOrder
  suggestedArgs?: Prisma.SortOrder
...
export type InsightSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  severity?: boolean
  status?: boolean
  suggestedActionId?: boolean
  suggestedArgs?: boolean
  objectKind?: boolean
  objectId?: boolean
  runId?: boolean
  expiresAt?: boolean
...
export type InsightOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "organizationId" | "agent" | "dedupeKey" | "kind" | "title" | "body" | "severity" | "status" | "suggestedActionId" | "suggestedArgs" | "objectKind" | "objectId" | "runId" | "expiresAt" | "acknowledgedAt" | "acknowledgedByUserId" | "metadata" | "createdAt" | "updatedAt", ExtArgs["result"]["insight"]>
...
export type $InsightPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    ...
    agent: $Enums.Agent
    /**
     * Stable key so a re-detect updates in place instead of stacking duplicates.
     * 
     * MUST carry a period segment, e.g. "lex.renewal:{sourceId}:2026-Q1". A key
     * without one makes a dismissal permanent: the nightly scan upserts onto the
     * dismissed row forever and the customer never sees the item again.
     */
    dedupeKey: string
    /**
     * Dotted detector name, e.g. "lex.renewal-due".
     */
    kind: string
    /**
     * One-line finding.
    ...
    status: $Enums.InsightStatus
    /**
     * Frontend AgentActionId offered as the next step.
     */
    suggestedActionId: string | null
    /**
     * Prefill for that action's form.
     */
    suggestedArgs: runtime.JsonValue | null
    /**
    ...
    objectId: string | null
    /**
     * Run that produced it, when a planned run did.
     */
    runId: string | null
    /**
     * When this stops being worth showing.
     */
    expiresAt: Date | null
    acknowledgedAt: Date | null
    acknowledgedByUserId: string | null
...
export interface InsightFieldRefs {
  ...
  readonly agent: Prisma.FieldRef<"Insight", 'Agent'>
  readonly dedupeKey: Prisma.FieldRef<"Insight", 'String'>
  ...
  readonly suggestedActionId: Prisma.FieldRef<"Insight", 'String'>
  readonly suggestedArgs: Prisma.FieldRef<"Insight", 'Json'>
  readonly objectKind: Prisma.FieldRef<"Insight", 'String'>
  readonly objectId: Prisma.FieldRef<"Insight", 'String'>
  readonly runId: Prisma.FieldRef<"Insight", 'String'>
  readonly expiresAt: Prisma.FieldRef<"Insight", 'DateTime'>
  readonly acknowledgedAt: Prisma.FieldRef<"Insight", 'DateTime'>
  readonly acknowledgedByUserId: Prisma.FieldRef<"Insight", 'String'>
