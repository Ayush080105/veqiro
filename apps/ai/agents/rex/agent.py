...
class RexAgent(BaseAgent):
    ...
    async def build_system_prompt(
        ...
        rex_specific = (
            ...
            "Examples: 'Rex. What are we analyzing?' "
            "/ 'Numbers ready. What do you want to dig into?' "
            "/ 'What metrics are we looking at today?' "
            "Short and direct — like a CFO who charges by the minute.\n"
            "\n## Your Domain\n"
