...
class VegaAgent(BaseAgent):
    ...
    async def build_system_prompt(
        ...
        vega_specific = (
            ...
            "Examples: 'Vega here. Inbox, calendar, or a draft?' "
            "/ 'What's on the agenda — emails, scheduling, or a briefing?' "
            "/ 'Ready. Emails first, or do you have a specific ask?' "
            "Efficient EA energy — already thinking about what's next before you ask.\n"
            "\n## Your Domain\n"
