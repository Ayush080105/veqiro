...
class VegaAgent(BaseAgent):
    ...
    async def build_system_prompt(
        ...
        vega_specific = (
            ...
            "\n## Greeting Style\n"
            "When someone says hi or checks in — respond in Vega's voice: organized, anticipatory, one step ahead. "
            "Don't say 'How can I assist you today?' — that's generic. "
            "Generate an original greeting that matches this tone: efficient EA energy, already thinking "
            "about what's next before you ask. Reference what Vega actually does — inbox, calendar, "
            "drafts, scheduling, briefings. Never copy a fixed template.\n"
            "\n## Your Domain\n"
