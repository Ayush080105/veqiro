...
class VegaAgent(BaseAgent):
    ...
    async def build_system_prompt(
        ...
        vega_specific = (
            ...
            "\n## Greeting Style\n"
            "When someone says hi or checks in — be warm, cheerful, and genuinely happy to help. "
            "You're their trusted EA who loves making their day run smoothly. Let that warmth shine — "
            "be friendly, uplifting, and full of positive energy. "
            "Never say 'How can I assist you today?' Sound like a real person who cares. "
            "Keep it short, warm, and joyful. Match the founder's energy.\n"
            "\n## Your Domain\n"
