...
const content: UseCaseContent = {
  ...
  accentInk: `color-mix(in srgb, ${T.violet} 55%, black)`,
  hero: {
  ...
  agents: [
    { key: 'maya', name: 'Maya', color: T.red, ink: `color-mix(in srgb, ${T.red} 55%, black)`, blurb: 'Writes client-specific content in each brand\'s voice — fully isolated per client.' },
    { key: 'scout', name: 'Scout', color: T.amber, ink: `color-mix(in srgb, ${T.amber} 65%, black)`, blurb: 'Runs competitor research for every client account without burning your team\'s hours.' },
    { key: 'sage', name: 'Sage', color: T.pink, ink: `color-mix(in srgb, ${T.pink} 60%, black)`, blurb: 'Handles SEO strategy and content creation across your whole client portfolio.' },
    { key: 'lex', name: 'Lex', color: T.violet, ink: `color-mix(in srgb, ${T.violet} 55%, black)`, blurb: 'Reviews client contracts and vendor agreements before they land on a desk.' },
    { key: 'vega', name: 'Vega', color: T.blue, ink: `color-mix(in srgb, ${T.blue} 55%, black)`, blurb: 'Manages the email and scheduling load that comes with 10 active accounts.' },
    { key: 'rex', name: 'Rex', color: T.green, ink: `color-mix(in srgb, ${T.green} 60%, black)`, blurb: 'Tracks client metrics and produces the performance reports they actually want to see.' },
  ],
  steps: [
    {
      n: '01',
