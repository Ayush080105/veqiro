      ...
      <section style={{ padding: 'clamp(48px, 8vw, 80px) clamp(16px, 4vw, 32px)' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <Section n="5" title="Termination">
            ...
            <P>You may cancel your account at any time. Upon termination, your access ceases and your data is handled per our <a href="/privacy" style={{ color: T.ink, fontWeight: 700 }}>Privacy Policy</a>.</P>
          </Section>
          ...
          <Section n="8" title="Contact">
            <P>Questions about these Terms? Reach us at <a href={`mailto:${contact.email}`} style={{ color: T.ink, fontWeight: 700 }}>{contact.email}</a></P>
