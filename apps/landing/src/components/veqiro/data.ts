...
export const EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    color: '#F06464',
    ink: '#7A1717',
    skills: ['Content ideation', 'Post drafting', 'Cross-platform', 'Direct publishing', 'Product campaigns', 'Carousels'],
    quote: "LinkedIn post ready. Twitter thread: 6 tweets. Instagram: captioned and hashtagged. Which goes live first?",
    ...
    capabilities: [
      { title: "Content Ideation", description: "3–10 platform-specific ideas with hooks, angles, and on-brand image prompts." },
      { title: "Full Content Drafting", description: "Complete post with tone control, brand kit applied, and image auto-generated — including multi-slide carousel posts for LinkedIn or Instagram." },
      { title: "Cross-Platform Variants", description: "One post rewritten natively for every platform — correct length, tone, format." },
      { title: "Direct Publishing", description: "Approve and it goes live. No copy-paste. No scheduling tool." },
      { title: "Revision & Image Regeneration", description: "Paste feedback, get a new draft. Describe the image, get a new one — brand colors and logo stay locked in." },
      { title: "Product Campaign Creator", description: "Upload one product photo — get a full campaign set of images composed for each placement (hero, square, story, ad) plus a ready caption." },
    ],
    useCases: [
    ...
    demoChat: [
      { role: 'user', content: "Maya, 3 ideas for our product launch next week.", delayMs: 800 },
      { role: 'agent', content: "Here: (1) 'Before/after' — shows the pain without the product. (2) Founder's honest take — 'what I wish I had.' (3) Pure results hook — lead with the number. I'd go with (2) for launch day. Draft it for LinkedIn?", delayMs: 1800 },
      { role: 'user', content: "Yes. Then adapt it for Twitter and Instagram.", delayMs: 3200 },
      { role: 'agent', content: "LinkedIn draft ready — image generated in your brand colors. Twitter thread: 6 tweets, hook pulls the best line. Instagram: caption trimmed, hashtags added. All three ready. Post LinkedIn now?", delayMs: 5000 },
    ],
    ...
    actions: [
      "Generate 3 LinkedIn post ideas about [topic] with image prompts",
      "Draft a Twitter thread about our new [feature]",
      "Take this LinkedIn post and rewrite it natively for Instagram and Twitter",
      "Revise this draft — make it punchier, cut 30 words",
      "Publish this post to my LinkedIn now",
      "Regenerate the image — darker, logo centered, no text overlay",
